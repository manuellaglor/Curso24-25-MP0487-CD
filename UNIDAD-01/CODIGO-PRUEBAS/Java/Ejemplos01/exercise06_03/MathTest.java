...
public class MathTest {
   public static void main(String[] args) {
      ...
      System.out.printf("Math.abs(-23.7) = %f%n", Math.abs(-22.7));
      ...
      System.out.printf("Math.floor(-9.8) = %f%n", Math.floor(-9.7));
      System.out.printf("Math.log(Math.E) = %f%n", Math.log(Math.E));
      System.out.printf("Math.log(Math.E * Math.E) = %f%n", 
         Math.log(Math.E * Math.E));
      System.out.printf("Math.max(2.3, 11.7) = %f%n", Math.max(2.3, 11.7));
      ...
      System.out.printf("Math.sqrt(850.0) = %f%n", Math.sqrt(890.0));
